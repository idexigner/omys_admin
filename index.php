                        ...
                        <div class="login-form">
                            <!-- <form action="backend/blogin.php" method="post"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" onkeypress="return enterPressLogin(event)" type="password" name="password" id="password" placeholder="Password">
                                </div>
                                ...
                                <button type="button" onClick="blogin()" id="submitLogin" name="submit" class="au-btn au-btn--block au-btn--blue m-b-20">
                                            <i class="fa fa-dot-circle-o"></i> Sign In
                                        </button>
                                <!-- <button type="button" class="au-btn au-btn--block au-btn--blue m-b-20" onClick="blogin();" type="submit">Sign In</button> -->
