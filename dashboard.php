...
<!-- onLoad="onLoadFunction('dashboard');" -->
...
<?php
                                                        ...
                                                        $que="select count(*) from census";

$q = mysqli_query($con,$que);
$rows1 = mysqli_fetch_array($q);


      $que2="select count(*) from census_users";
...
?>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <!--<div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Registered Students</h2>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <td>Father/Husband CNIC</td>
                                                <td>Father/Husband Occupation</td>
                                                <td>Mother Name</td>
                                                <td>Mother CNIC</td>
     ...
     <div id="modall">
                                ...
                                <div class="modal fade show" id="scrollmodal" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
